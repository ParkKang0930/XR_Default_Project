...
public class PK_ScrollRect : UIBehaviour, IInitializePotentialDragHandler, IBeginDragHandler, IEndDragHandler, IDragHandler, IScrollHandler, ICanvasElement, ILayoutElement, ILayoutGroup
{
    /// <summary>
...
#pragma warning restore 649
    ...
    protected virtual void LateUpdate()
    {
        ...
        if (m_Dragging && m_Inertia && deltaTime != 0)
        {
